    ...
    <div className="bg-gray-50 min-h-screen animate-fade-in">
      ...
      <section className="relative h-[50vh] min-h-[400px] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src="/suporte.png" alt="Fale Conosco Mulato Business" className="w-full h-full object-cover" />
                ...
                <div className="space-y-8 relative z-10">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-lg font-medium leading-snug">Centralidade do Kilamba,<br />Q14, 5º Andar</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gold flex-shrink-0">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <input type="text" name="name" value={formData.name} onChange={handleChange} required
                        className="w-full p-3 bg-gray-50 border border-gray-200 rounded-sm focus:outline-none focus:border-gold focus:ring-1 focus:ring-gold transition-all" placeholder="Seu nome" />
                    </div>
                    <div className="space-y-2">
                      <label className="text-xs font-bold text-gray-500 uppercase tracking-wider">Telefone</label>
                      <input type="tel" name="phone" value={formData.phone} onChange={handleChange} required
                        className="w-full p-3 bg-gray-50 border border-gray-200 rounded-sm focus:outline-none focus:border-gold focus:ring-1 focus:ring-gold transition-all" placeholder="+244 9xx xxx xxx" />
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <input type="email" name="email" value={formData.email} onChange={handleChange} required
                      className="w-full p-3 bg-gray-50 border border-gray-200 rounded-sm focus:outline-none focus:border-gold focus:ring-1 focus:ring-gold transition-all" placeholder="seu.email@empresa.com" />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea name="message" value={formData.message} onChange={handleChange} rows={5}
                      className="w-full p-3 bg-gray-50 border border-gray-200 rounded-sm focus:outline-none focus:border-gold focus:ring-1 focus:ring-gold transition-all resize-none" placeholder="Como podemos ajudar?"></textarea>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    <input
                      ...
                      required
                    />
                    <label htmlFor="privacy-contact" className="text-sm text-gray-600 cursor-pointer">
                  ...
                  <button type="submit" disabled={!acceptedPrivacy}
                    className="w-full gold-gradient-bg text-white p-4 rounded-sm font-bold uppercase tracking-widest hover:shadow-xl hover:brightness-110 transition-all duration-300 flex items-center justify-center gap-2 group disabled:opacity-50 disabled:cursor-not-allowed">
                    Enviar Mensagem
