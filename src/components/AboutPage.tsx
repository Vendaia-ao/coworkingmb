          ...
          <div className="bg-white rounded-xl shadow-2xl overflow-hidden border border-gray-100 flex flex-col lg:flex-row">
            <div className="w-full lg:w-1/2 p-8 md:p-16 flex flex-col justify-center bg-texture-noise">
              ...
              <div className="space-y-6 text-gray-600 leading-relaxed text-lg">
                <p>A <strong className="text-brand-dark">Coworking MB</strong> é um espaço pensado para profissionais, startups, freelancers e empresas que procuram flexibilidade, estrutura e um ambiente profissional para crescer.</p>
                <p>Com soluções adaptáveis, oferecemos desde escritórios virtuais até salas completas, sempre com foco no conforto, eficiência e credibilidade dos nossos clientes.</p>
              </div>
              <div className="mt-10">
                <button onClick={() => document.getElementById('booking-section')?.scrollIntoView({behavior: 'smooth'})}
                  ...
                  Agendar uma Visita <ArrowRight size={16} />
                </button>
              </div>
            </div>
            <div className="w-full lg:w-1/2 relative min-h-[400px]">
              ...
              <div className="absolute bottom-8 left-8 right-8 glass-panel p-6 rounded-lg border-l-4 border-gold">
                <p className="text-brand-dark font-serif italic text-lg">"Onde a sua empresa encontra o ambiente ideal para prosperar."</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          {stats.map((stat, i) => (
            <motion.div key={i} className="text-center p-8 rounded-xl border border-gray-100 shadow-sm hover:shadow-lg transition-shadow"
              ...
              <div className="w-14 h-14 rounded-full gold-gradient-bg flex items-center justify-center mx-auto mb-4 text-white">
                <stat.icon size={24} />
              </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
          <motion.div className="bg-white p-10 rounded-xl shadow-lg border border-gray-100" initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
            ...
            <p className="text-gray-600 leading-relaxed text-lg">
              A nossa missão é oferecer soluções de trabalho flexíveis e acessíveis, promovendo um ambiente profissional que estimule a produtividade, a colaboração e o networking entre empreendedores, profissionais independentes e empresas.
            </p>
          </motion.div>
          ...
          <motion.div className="bg-white p-10 rounded-xl shadow-lg border border-gray-100" initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
            ...
            <p className="text-gray-600 leading-relaxed text-lg">
              Ser reconhecida como a principal referência em espaços de trabalho partilhados no Kilamba e em Angola. Contribuindo para o fortalecimento do ecossistema empreendedor e para o crescimento sustentável dos nossos clientes.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 bg-brand-dark text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-serif font-bold mb-4">Nossos Valores</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            {values.map((item, index) => (
              <div key={index} className="glass-dark p-6 rounded-lg border border-white/10 hover:border-gold/30 transition-all duration-300 group hover:-translate-y-2 text-center">
                <div className="w-12 h-12 rounded-full bg-gold/10 flex items-center justify-center mb-4 mx-auto group-hover:bg-gold text-gold group-hover:text-white transition-colors duration-300">
                  <item.icon size={24} />
                </div>
